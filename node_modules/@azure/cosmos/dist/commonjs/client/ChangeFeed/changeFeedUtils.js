...
exports.buildFeedOptions = buildFeedOptions;
...
function buildFeedOptions(changeFeedOptions, continuationToken, startFromNow, startTime) {
    ...
    if (startTime) {
        feedOptions.initialHeaders[index_js_2.Constants.HttpHeaders.IfModifiedSince] = startTime;
    }
    if (changeFeedOptions.changeFeedMode &&
        changeFeedOptions.changeFeedMode === ChangeFeedMode_js_1.ChangeFeedMode.AllVersionsAndDeletes) {
